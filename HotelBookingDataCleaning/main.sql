...
Throughout the data cleaning process, it is recommended to document the steps taken, any assumptions made, and the rationale behind the decisions. This documentation will be helpful for future reference and collaboration.

After completing the data cleaning process, the cleaned and transformed Hotel Booking Demand dataset will be ready for further analysis, such as exploring descriptive statistics, building predictive models, or generating insights and recommendations for the hotel business.
...
/*
Observation: During this Data Investigation, we made the following observations and conclusions:
...
6. Total Number of rows in this table is 64
7. Reservation_status_date (object) should be converted to a datetime.
*/


/** Data Cleaning **/
-- Check the datatyp[e of the dataset
DESCRIBE hotel_bookings;
...
/* 
Based on we have gone throuh sql qwery 
Data Cleansing Report-Through Our SQL Queries:
...
-- Noteable it's thrwoing error due to compatibility of column datatype we should alter to 
ALTER TABLE hotel_bookings
